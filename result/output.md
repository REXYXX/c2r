...
- Validation Agent 入口：`D:\c2rust\c2rust\c2rust\result\harness\agent-entry\validation-agent.json`
- 执行 trace：`D:\c2rust\c2rust\c2rust\logs\trace\profile-harness-path.md`
